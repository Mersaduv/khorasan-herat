...
const aboutContent: Record<Locale, AboutContent> = {
  fa: {
    heroEyebrow: "درباره خراسان هرات",
    heroTitle: "روایت روشن از تولید فولاد، اعتماد بازار و پشتیبانی حرفه‌ای از همه پروژه‌ها",
    heroDescription:
      "خراسان هرات یکی از مجموعه‌های اثرگذار صنعت فولاد افغانستان است؛ برندی که با تمرکز بر تولید سیخ‌گول، کیفیت پایدار، فروش پاسخ‌گو و همراهی حرفه‌ای با پروژه‌های کوچک و بزرگ، جایگاه قابل اتکایی در بازار به دست آورده است.",
    heroStats: [
    ...
    storyParagraphs: [
      ...
      "در کنار توان تولید، خراسان هرات بر دسترس‌پذیری، فروش مستقیم، هماهنگی سریع و حضور عملیاتی در هرات نیز تاکید دارد؛ موضوعی که ارتباط با شرکت را برای خریداران، مجریان و مجموعه‌های همکار ساده‌تر و مطمئن‌تر می‌کند.",
    ],
    capabilityEyebrow: "توانمندی‌ها",
    capabilityTitle: "نمایی روشن از توان تولید، کیفیت محصول و سازوکار همکاری",
    capabilityDescription:
      "چکیده زیر، معرفی ساختاریافته‌ای از مهم‌ترین ظرفیت‌های خراسان هرات است تا کاربر در زمان کوتاه‌تر، تصویر دقیق‌تری از توان فنی و خدماتی شرکت به دست آورد.",
    capabilities: [
      {
    ...
    title:
      activeLocale === "en"
        ...
        : activeLocale === "ps"
          ...
          : "درباره خراسان هرات | تولید فولاد، کیفیت میلگرد و تامین پروژه‌ها",
